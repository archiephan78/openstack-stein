...
GRANT ALL PRIVILEGES ON nova_cell1.* TO 'nova_cell1'@'localhost' IDENTIFIED BY '$NOVA_CELL1_DBPASS';
GRANT ALL PRIVILEGES ON nova_cell1.* TO 'nova_cell1'@'%' IDENTIFIED BY '$NOVA_CELL1_DBPASS';
FLUSH PRIVILEGES;
EOF
